...
## Project Structure
deadline-radar/ ├── public/ │ └── index.html ├── src/ │ ├── App.js # Main app (DeadlineRadar) │ ├── App.css # Styling (glassmorphism theme) │ ├── deadline-radar.jsx # Optional component / reference │ ├── index.js │ ├── index.css │ └── ... # assets, helpers, tests ├── assets/ # screenshots/gifs for README ├── package.json ├── README.md └── .gitignore
...
Paste the JSON into a file to save.
Future versions will include export/import and cloud sync.

Usage Guide
Add a Deadline
Click ✨ Add Deadline
Fill in: Task name, Course, Due date/time (optional), Source (optional)
Submit — task is saved and appears in the list
Edit / Delete
...
Adjust the notification threshold (default 24 hours) inside src/App.js:
...
Deploy to Netlify
Build: npm run build
Drag build/ to Netlify or use Netlify CLI
Roadmap
...
Made by [Your Name] — replace with your name and GitHub link